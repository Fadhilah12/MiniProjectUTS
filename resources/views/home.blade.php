...
@section('content')
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="{{ Vite::asset('images/welcome.png') }}" alt="main welcome">
                </div>
    ...
    <section id="image" class="jumbotron text-center ">
        <img src="{{ Vite::asset('images/biodata.png') }}" class="rounded-circle position-middle border border-3"
            alt="image" width=20%>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{ Vite::asset('images/produk1.jpg') }}" class="card-img-top" alt="project">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{ Vite::asset('images/produk2.jpg') }}" class="card-img-top" alt="project">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{ Vite::asset('images/produk3.jpg') }}" class="card-img-top" alt="project">
                        <div class="card-body">
